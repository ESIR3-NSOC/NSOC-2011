...
newcomponent.getNeededPorts().put("toConsole",createServerComponentPORTtoConsole(newcomponent))
...
def createServerComponentPORTtoConsole(component : ServerComponent) : ServerComponentPORTtoConsole ={ return new ServerComponentPORTtoConsole(component);}
