...
public class DeviceDAOSQLite   implements DeviceDAO {

    /*
    * Class Attributes
    */

    private static Logger logger = LoggerFactory.getLogger(DeviceDAOSQLite.class.getName());
    ...
    public DeviceDAOSQLite(ConnectionDbSQLite connectionDbSQLite) {
    ...
    public Device retrieve(UUID id) {
        ...
        try {
            ...
            System.out.println("Device retrieve error"+ exception);
        }
        return device;
    }
