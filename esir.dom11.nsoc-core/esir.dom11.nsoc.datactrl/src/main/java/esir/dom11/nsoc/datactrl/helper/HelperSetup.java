...
public abstract class HelperSetup {
    ...
    */
    ...
    public void setupData() {
        ...
        // Devices
        Device deviceTemp = _daoFactory.getDeviceDAO().create(new Sensor(DataType.TEMPERATURE,"bat7/930"));
        Device deviceBrightness = _daoFactory.getDeviceDAO().create(new Sensor(DataType.BRIGHTNESS,"bat7/930"));
        Device deviceHumidity = _daoFactory.getDeviceDAO().create(new Sensor(DataType.HUMIDITY,"bat7/930"));
        Device devicePower =  _daoFactory.getDeviceDAO().create(new Sensor(DataType.POWER,"bat7/930"));
